...
#    url(r'^$','mumbai.views.index', name='index'),
    ...
    url(r'^tweety/$','views.tweety', name='tweety'),
    url(r'^autocomplete/$', 'mumbai.views.autocomplete', name='autocomplete'),
#    url(r'^static/(?P<path>.*)$','django.views.static.serve', {'document_root':'./static'}),
    (r'^routes/$', 'mumbai.views.routes'),
    (r'^route/(?P<code>[a-zA-Z0-9\s\-]*?)/$', 'mumbai.views.route'),
    (r'^route/(?P<code>[a-zA-Z0-9\s\-]*?)/georss/$', RouteFeed()),
    (r'^areas/$', 'mumbai.views.areas'),
    (r'^area/(?P<slug>.*?)/$', 'mumbai.views.area'),
